...
const SignupForm = () => {
  ...
  const handleSignup=async(data)=>{
          ...
          else toast.error("Somethings goes wrong,try again later");
        };
      ...
      <input
        ...
        <div className="flex flex-col">
          <div className="flex gap-4">
            ...
            <input 
            {...register("gender")} 
            type="radio" defaultChecked={true} value="boy" name="gender" id="male" />
          ...
          <div className="flex gap-4">
            <input 
            {...register("gender")}
             type="radio" value="girl" name="gender" id="female" />
        ...
        <Link className="text-center underline text-sm" to="/login">
        Have a account? log in </Link>
      </fieldset>
    </form>
  );
};
